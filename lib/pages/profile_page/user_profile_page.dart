...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    String followButtonText =context.read<MyUserBloc>().state.user!.isFollowing(context.read<MyUserBloc>().state.user!, widget.thisUser!.id) ? "Takipten Çık" : "Takip Et";
                        ...
                        child: SizedBox(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                style:  ButtonStyle(backgroundColor:followButtonText=="Takip Et" ? const WidgetStatePropertyAll(Colors.black) :const WidgetStatePropertyAll(Colors.white), ),
                                onPressed: () {
                                
                                setState(() {
                                  followButtonText=="Takip Et" ? userRepository.followUser(context.read<MyUserBloc>().state.user!, widget.thisUser!) :userRepository.unfollowUser(context.read<MyUserBloc>().state.user!, widget.thisUser!);
                                });
                              }, child:  Text(followButtonText , style: TextStyle(color:followButtonText=="Takip Et" ?Colors.white:Colors.black ),)),
                            ],
                          ),
                        ),
                      );
